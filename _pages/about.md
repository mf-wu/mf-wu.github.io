...
<div id="about-me" class="intro-section">
  ...
  <p class="research-focus">
    ...
    Currently, I'm exploring the frontiers of <strong>Agentic AI</strong> to build next-generation autonomous materials discovery systems, spanning multiple application domains:
  </p>
